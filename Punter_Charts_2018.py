...
tracking_df = pd.read_csv("/Users/charlestobin/Desktop/CLEAN_FILES/nfl-big-data-bowl-2022/tracking2018.csv")
...
#tommy_townsend = ballpp_df[(ballpp_df['displayName'] == 'Tommy Townsend')]

#tommy_townsend.info

#tt_received = tommy_townsend.loc[tommy_townsend['event'] == 'punt_received']
...
merged20['epaOppSub'] = -1 * ((((merged20['puntWI5'] * -1.32) + (merged20['puntWI10'] * -1.02) + (merged20['puntWI20'] * -0.55)) / 
                        ((merged20['puntWI5']) + (merged20['puntWI10']) + (merged20['puntWI20']))))
...
accSpider20_df
accSpider20_df[['Missed Direction', 'Directional Rating', 'Punt w/i 5 Rating', 'Punt w/i 10 Rating',
                'Punt w/i 20 Rating', 'Play Rating', 'EPS Rating', 'Not Returned Rating']] = scaler.fit_transform(accSpider20_df[['percentMiss', 'percentDirectional', 'puntWI5', 'puntWI10', 'puntWI20',
                                                                                                                                  'totalPlayValue', 'epaOppSub', 'percentNR']])
accSpider20_df = accSpider20_df[['displayName', 'Missed Direction', 'Directional Rating', 'Punt w/i 5 Rating', 'Punt w/i 10 Rating',
                'Punt w/i 20 Rating', 'Play Rating', 'EPS Rating', 'Not Returned Rating']]
...
for x in range(len(accSpider20_df['displayName'])):
    if accSpider20_df['displayName'][x] == 'A.J. Cole':
...
title1_text = axs['title'].text(0.01, 0.65, 'A.J. Cole', fontsize=25,
                                fontproperties=robotto_bold.prop, ha='left', va='center')
title2_text = axs['title'].text(0.01, 0.25, 'Las Vegas Raiders', fontsize=20,
                                fontproperties=robotto_regular.prop,
...
title4_text = axs['title'].text(0.99, 0.25, 'Punter', fontsize=20,
                                fontproperties=robotto_regular.prop,
